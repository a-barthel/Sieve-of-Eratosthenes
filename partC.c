...
int main() {
	printf("\nCalculate the non-crossed-out numbers p such that p = {p \u2208 \u2124 | 2*10^8 \u2264 p \u2264 2*10^8+10^6}.\n");
	int I = 2 * pow(10, 8);
	...
	printf("\nThe total number of non-crossed-out numbers between 2*10^8 and 2*10^8+10^6 is : %i\n", count);
